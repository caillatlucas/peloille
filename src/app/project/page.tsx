      ...
      <section className="relative h-[65vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-6 md:px-16 pb-12 max-w-[1600px] mx-auto w-full">
          <motion.div
            ...
            className="space-y-6"
          >
            <Link href="/" className="inline-flex items-center gap-3 text-white/50 hover:text-primary-green mb-8 transition-all uppercase tracking-[0.2em] text-[10px] font-bold group">
              <div className="p-2 bg-white/5 rounded-full group-hover:bg-primary-green/10 transition-all"><ArrowLeft size={14} /></div> Retour au portfolio
            </Link>
              ...
              <div className="mt-16 space-y-6 relative group/carousel">
                ...
                <div className="relative">
                  ...
                  <button 
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-4 rounded-full bg-black/60 backdrop-blur-xl border border-white/15 text-white hover:bg-primary-green hover:border-primary-green transition-all shadow-2xl opacity-0 group-hover/carousel:opacity-100 duration-300"
                  ...
                  <button 
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-4 rounded-full bg-black/60 backdrop-blur-xl border border-white/15 text-white hover:bg-primary-green hover:border-primary-green transition-all shadow-2xl opacity-0 group-hover/carousel:opacity-100 duration-300"
                    aria-label="Suivant"
                  >
                  ...
                  >
                    {project.gallery.map((item, i) => {
                      ...
                      return (
                        <div key={i} className="min-w-[85vw] md:min-w-[700px] aspect-video relative rounded-xl overflow-hidden shadow-2xl bg-text-black/5 snap-center border border-white/10 hover:border-primary-green/30 transition-all duration-300">
                          {isVideo ? (
                            <iframe 
                              width="100%" 
                              height="100%" 
          ...
          <div className="bg-[#0c0c0c]/85 backdrop-blur-2xl border border-white/15 p-12 rounded-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_20px_50px_rgba(0,0,0,0.8)] transition-all duration-300">
            <div className="flex justify-start mb-10 pb-6 border-b border-white/10">
              <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-2.5 rounded-full shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)]">
                <span className="w-2 h-2 bg-primary-green rounded-full animate-pulse shadow-[0_0_8px_var(--primary-green)]"></span>
                <span className="font-serif italic text-white text-lg font-medium">Détails</span>
              </div>
            </div>
            <div className="space-y-8">
              <div className="flex items-center gap-6">
                <div className="w-12 h-12 bg-white/5 flex items-center justify-center rounded-2xl text-primary-green border border-white/5 shrink-0">
                  <Calendar size={20} />
                </div>
                <div>
            ...
            {hasExternalLink && (
              <div className="mt-12">
                 <a 
                   ...
                   className="block w-full text-center bg-primary-green text-white py-5 rounded-2xl hover:bg-red-600 transition-all font-bold text-xs tracking-widest uppercase shadow-2xl shadow-primary-green/30"
                 >
                    Voir le site live
                 </a>
              </div>
