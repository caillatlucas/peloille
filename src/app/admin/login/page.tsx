...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      ...
      >
        <Link href="/" className="absolute -top-12 left-0 text-text-black/50 hover:text-primary-green flex items-center gap-2 text-sm uppercase tracking-widest font-medium transition-colors">
          <ArrowLeft size={16} /> Retour au site
        </Link>
        <div className="text-center mb-8">
          <h1 className="font-serif text-4xl text-primary-green mb-2 tracking-tighter">PELOILLE</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input 
                ...
                className="w-full bg-transparent border border-text-black/20 rounded-sm px-4 py-3 focus:outline-none focus:border-primary-green transition-colors"
            ...
            {error && (
              <p className="text-primary-green text-sm font-medium">{error}</p>
            )}
          ...
          <form onSubmit={handleMfaVerify} className="space-y-6">
            ...
            <div>
                <input 
                  ...
                  className="w-full bg-transparent border border-text-black/20 rounded-sm px-4 py-4 text-center text-3xl tracking-[0.5em] font-serif focus:outline-none focus:border-primary-green transition-colors"
                  placeholder="000000"
                  maxLength={6}
                  required
                  autoFocus
            ...
            {error && (
              <p className="text-primary-green text-sm font-medium text-center">{error}</p>
            )}
